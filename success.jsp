...
for Mitigating <center>the Risk of Customer Churn</center></b></a></h1>		 -->
		...
		<div id="content_bg">
					...
					<div id="slider-wrapper">
						<div id="slider" class="nivoSlider">
							<img src="images/header.jpg" alt="" /> <img
								...
								src="images/header3.jpg" alt="" /> <img
			...
			<div id="content_white">
				...
				<div id="content">
					<div id="content_left">
						<img src="images/su.jpg" alt="" title=""
							style="margin-left: 60px; margin-top: 90px;" width=400px; />

						<div class="read"></div>
						<div class="clear"></div>
						<div class="column2">
							<div class="left_col1"></div>
							<div class="left_col2"></div>
						</div>
					</div>
					<div id="content_right">
						...
						<div class="content_right_pad">
							<div class="news">
								<img src="images/i2.jpg" alt="" title="" /> <span class="date"></span>
								<div class="read"></div>
								<div class="clear"></div>
							</div>
						</div>
						...
						<div class="content_right_pad">
							<div class="news">
								<img src="images/i3.jpg" alt="" title="" /> <span class="date"></span>
								<div class="read"></div>
								<div class="clear"></div>
							</div>
						</div>
