		...
		<div id="content_bg">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="membership_login.jsp">Member</a></li>
			...
			<div id="content_white">
				...
				<div id="content">
					<div id="content_left">
						<font style="font: italic small-caps bold 25px Georgia;color:blue; ">NetWork Subscriber Membership Login...</h2>

						<form action="mem.jsp" name="f" method="get" onsubmit="return validation()">
							<table style="margin-left: 50px;" cellpadding="10px" cellspacing="10px">
								<tr>
									<td> <h4 style="font:italic small-caps bold 20px Georgia;font-size:18px;color:maroon;">Membership No</font>
									<td><input type="text" name="membership" class="tex1"></td>
								</tr>
								
								<tr>
									<td> <h4 style="font:italic small-caps bold 20px Georgia;font-size:18px;color:maroon;">Password</font>
									<td><input type="password" name="pass" class="tex1"></td>
								</tr>
								
								<tr>
									<td colspan="2" align="center"><input type="submit" class="btn"
										name="submit" value="Login"><input type="reset" class="btn" name="clear" value="Clear"></td>
								</tr>
							</table>
					...
					<div id="content_right">
						...
						<div class="content_right_pad">
							<div class="news" style="margin-left: 30px;">
								<img src="images/m.jpg" alt="" title="" width="250px"
									height="200px" />
