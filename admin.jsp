...
<center> <img src="images/h2.gif" alt="" /> </center>
		...
		<div id="content_bg">
			...
			<div id="content_white">
				...
				<div id="content">
					<div id="content_left">
						<font style="font: italic small-caps bold 25px Georgia;color:blue; ">Network Administrator Login...</font>

						<form action="admin" name="f" method="post" onsubmit="return validation()">
							<table style="margin-left: 50px;" cellpadding="10px" cellspacing="10px">
								<tr>
									<td><h4 style="font:italic small-caps bold 20px Georgia;font-size:18px;color:maroon;">Admin </h4></td>
									<td><input type="text" name="name" class="tex1"></td>
								</tr>
								
								<tr>
									<td><h4 style="font:italic small-caps bold 20px Georgia;font-size:18px;color:maroon;">Password</h4></td>
					...
					<div id="content_right">
						...
						<div class="content_right_pad">
							<div class="news" style="margin-left: 30px;">
								<img src="images/images (3).jpg" alt="" title="" width="250px"
									height="200px" />
