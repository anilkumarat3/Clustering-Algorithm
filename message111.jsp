...
<center> <img src="images/h2.gif" alt="" /> </center>
		...
		<div id="content_bg">
			...
			<div id="content_white">
				...
				<div id="content">
					<div id="content_left">
						<font style="font: italic small-caps bold 25px Georgia;color:blue;">Messages</font>

						<%
							String keying1 = request.getParameter("key");
							int keying = Integer.valueOf(keying1);
							...
							try {
								...
								BasicDBObject object = new BasicDBObject("_id", new ObjectId(idid));
								//object.put("Name", "Sudha");
								//DBCursor cursor11 = collection11.findon
								DBObject object2 = collection11.findOne(object);
								DBCursor cursor11 = collection11.find(object2);
								while (cursor11.hasNext()) {

									DBObject object12 = cursor11.next();

									msg = (String) object12.get("msg");
									key = (Integer) object12.get("enkey");
