...
<form action="deactive.jsp" name="f" enctype="multipart/form-data" method="get" onsubmit= "return validation()" style="margin-top:200px;">
<table class="gridtable">
<tr>
<font style="font: italic small-caps bold 25px Georgia;color:blue; "><center> VIEW_FEEDBACK_DETAILS</center></td>
</center>
</tr>
<tr>
...
try
{
	...
	DBCursor cursor = collection.find(new BasicDBObject("status","pending").append("NetworkType", network));
...
<tr>
	...
	<td><h4 style="font:italic small-caps bold 20px Georgia;font-size:18px;color:olive;margin-left:-36px;">
	 	<a href="maildb.jsp?name=<%=object.get("email")%>&aa=<%=object.get("Name")%>">OK</a>
	 </td>																	
</tr>	
