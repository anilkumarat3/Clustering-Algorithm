			...
			<div id="content_white">
				...
				<div id="content">
					<div id="content_left">
						...
						<div class="amar">
							<table style="margin-left: -130px;" cellpadding="10px" cellspacing="10px" bgcolor="green" > 
						
						<form method="post" name="form">
                        
                        <tr> 
                          <td ><font color="black" size="4">Customer Anaylise</font> 
                          </td>
                        ...
                        <tr> 
                          ...
                          <td> <table height="100" width="100">
                              <tr> 
                                ...
                                <td width="60"> <input type='radio' name="p3" class="btn" onclick="document.location.href='search1.jsp';"/>
                                  Network</td>
					...
					<div id="content_right">
						...
						<div class="content_right_pad">
							<div class="news" style="margin-left: 30px;">
								...
								<a href="groupmsg.jsp">Group Message</a><br/>
								<a href="analyst.jsp">Customer Analyses</a>
