				...
				<div id="content">
					<div id="content_left">
						<h2 style="margin-top: 40px">Messages</h2>
								...
								<div style="margin-left:612px; margin-top:120px; width:auto;"> 
       
     
<!-- <div style="margin-left:612px; margin-top:120px; width:auto;">
       <h3><font color="#CC3333">Messages</font></h3> -->
<%
...
//System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%qqqq:"+id1); 
    ...
    <table>
    <tr>
   	 <td><font color="#000000">From : </font></td>
     ...
     <tr>
     <td></td>
      <td><a href="delmsg.jsp?<%=id1%>"><button name="del" class="delit">Delete</button></a></td> 
     </tr>
     </table>
     </div>
    <%	
	  ...
	  try
		{
			...
			while(rs93.next())
				...
				<h3 align="center"><font color="#009900">Request Sent Successfully !!! You Have Subscribed for <font color="#CC3366">"<%=packed%>"</font></font></h3><br /><%
				}
		}
		catch(Exception e)
		{
