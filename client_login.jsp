	...
	<div id="wrap">
		...
		<div id="content_bg">
			...
			<div id="content_white">
				<div id="content">
					<div id="content_left">				
					<font style="font: italic small-caps bold 25px Georgia;color:blue; "> Client Login: </font>
						<form action="logvalid.jsp" name="f" method="post" onsubmit="return validation()">
							<table style="margin-left: 50px;" cellpadding="10px" cellspacing="10px">
								<tr>
									...
									<td><input class="tex1" type="text" name="name" class="textbox"></td>
								</tr>								
								<tr>
								...
								<tr>
									...
									<td>
										<a href="client_reg.jsp">
											<u><font size="+1" color="maroon">New Client Register Here</font></u>
										</a>
									</td>
								</tr>
							</table>							
					...
					<div id="content_right">						
						<div class="content_right_pad">
							<div class="news" style="margin-left: 30px;">
								<img src="images/i4.jpg" alt="" title="" width="250px" height="200px" />
								<div class="clear"></div>
							</div>
						</div>
					</div>
